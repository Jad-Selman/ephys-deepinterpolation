# This script serves as an example of the application of deepinterpolation denoising approach. 
...
# Note: This script can used to generate different models that adopts the deepinterpolation approach for the same dataset, but which differ in the parameters. 
...
if __name__ == '__main__':
    ...
    generator_param["end_frame"] = 30000
    ...
    ] = 1 #try to increase it, maybe to 2-5.
    ...
    jobdir = os.path.join(
        "/Users/jadse/deepinterpolation/trials-different-batches/28000 samples", training_param["model_string"] + "_" + run_uid,
    )
